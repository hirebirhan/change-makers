        ...
        <Tabs defaultValue="analyze">
          ...
          <TabsContent value="analyze" className="mt-4 space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Gemini will analyze your channel data — top videos, tags, subscriber count, and engagement — to surface strengths, gaps, and growth recommendations.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="topics" className="mt-4 space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Gemini combines your best-performing content with current Google Trends to suggest 8 specific video ideas with titles, hooks, and key points.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="description" className="mt-4 space-y-4">
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                />
                <Button
                  onClick={() => callGemini("description", { existingTitle: descTitleInput })}
                  disabled={!descTitleInput.trim() || loadingMode === "description"}
                >
          ...
          <TabsContent value="title" className="mt-4 space-y-4">
            <Card>
              ...
              <CardContent className="space-y-3">
                <Input
                  placeholder="Existing title to optimize…"
                  value={titleInput}
                ...
                />
                <Button
                  onClick={() => callGemini("title", { existingTitle: titleInput, keyword: keywordInput })}
                  disabled={!titleInput.trim() || loadingMode === "title"}
                >
...
export default function AIPage() {
  ...
  return isAuthenticated ? <GeminiStudio /> : <LoginPage />;
}
